...
def test_get_extracted_file_name():
    ...
    model = TorchExpoModule(model=get_test_model(), model_name="FCN ResNet-18",
                            model_example=get_test_model_example())
    assert model.get_extracted_file_name() == "fcn_resnet18"

    model = TorchExpoModule(model=get_test_model(), model_name="GoogLeNet",
                            model_example=get_test_model_example())
    assert model.get_extracted_file_name() == "googlenet"

    model = TorchExpoModule(model=get_test_model(), model_name="Mask-R_CNN",
                            model_example=get_test_model_example())
